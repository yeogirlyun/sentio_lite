...
def send_dashboard(html_path: str, to_addrs: str):
    ...
    subject = f"Sentio Lite Dashboard: {os.path.basename(html_path)}"
    body = "See attached dashboard report."
    ...
    with smtplib.SMTP_SSL('smtp.gmail.com', 465) as server:
        ...
        print(f'Sent dashboard to {to_addrs}')
...
if __name__ == '__main__':
    ...
    args = p.parse_args()
    send_dashboard(args.html, args.to)
...
def create_email_body(summary, session_date, dashboard_filename, include_image=True):
    ...
    <body>
        ...
        <div class="footer">
            ...
            <p>Strategy: SIGOR (Rule-based Ensemble)</p>
        </div>
    </body>
    </html>
    """
